...
def batteries_check():
    try:
        print('Bateries are changed in {}%'.format(batteries * 0.01))
    except TypeError as e:
        raise RocketNotReadyError('Problem with batteries') from e

def circuits_check():
    try:
        print('Exists elements: {}, {}, {}'.format(circuits_parts['cell'], circuits_parts['resistore'], circuits_parts['tranzistore']))
...
fuel = 100
batteries = '20'
circuits_parts = { 'cell': True, 'resistore': True }
